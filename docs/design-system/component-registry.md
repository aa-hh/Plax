...
- **Contract:** nav order Home · Watchlist · libraries · Search · Settings (Media / Search / System groups in `browsingHubNav.js`; Settings footer-pinned). **Hosts:** Home, Library, Settings, Search, Detail, Watchlist all mount `.browsing-hub-nav-host`. 658/658 tests pass (CSS/comment-only change).
